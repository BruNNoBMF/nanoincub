<div class="page-header">
    <a href="?pagina=entrada">
        <button type="button" class="btn btn-default"><i class="far fa-plus-square"></i> Entrada</button>
    </a>
    <a href="?pagina=saida">
        <button type="button" class="btn btn-default"><i class="far fa-minus-square"></i> Saida</button>
    </a>
